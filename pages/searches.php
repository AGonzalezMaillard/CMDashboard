<div id="page-wrapper">
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while($row = mysqli_fetch_assoc($result)) {
            echo "<td>".$row["idExpediente"]."-".$row["nombre"];
            echo "</td><td>".utf8_encode($row["estado"]);
            echo "</td><td>".$row["consultor"];
            echo "</td><td>".$row["analistaPrincipal"];
            echo "</td><td>".$row["prioridad"];
            echo "</td><td>".$row["fechaOportunidad"];
            echo "</td><td>".$row["cliente"];
